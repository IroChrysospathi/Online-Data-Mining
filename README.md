...
- Fedde Koster
Maxiaxi products spider

- Vanna Pušić
Thomann products spider 
...
### COMPETITOR
Stores webshop information.

### PAGELINK
Stores relevant URLs per competitor.

### PRODUCT
Defines unique microphone products.

### PRODUCTLISTING
Represents a product on a specific webshop.

### PRICESNAPSHOT
Stores pricing data.

### CUSTOMER_SERVICE
Stores customer service policies.

### EXPERT_SUPPORT
Stores expert support features.

### CATEGORY
Stores product categories.

### PRODUCTMATCH
Links identical products across webshops.
